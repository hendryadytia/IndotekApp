...
const expand = () => displayLabel="block"
const collapse = () => displayLabel="none"

</script>


    <div class="pra-expanded" on:mouseenter={expand} on:mouseleave={collapse}>
        <svg class="logo" xmlns="http://www.w3.org/2000/svg" width="45.603" height="45.603" viewBox="0 0 45.603 45.603">
        ...
        <div class="menu">
            <Link to="/">
                <button style="margin-top: 30px;">
                    ...
                    <p style="margin-left: 20px; display: {displayLabel}; text-decoration:none">Dashboard</p>
                </button> 
            </Link>
            <p class="divider"/>
            <Link to="tambahmesin">
                <button>
                    <img src="./icons/mesin_tambah.png" alt="mesin tambah"/>
                
                    <p style="margin-left: 20px; display: {displayLabel};">Tambah Mesin</p>
                </button>
            </Link>
            <p class="divider"/>
            <Link to="daftarmesin">
                <button>
                    <img src="./icons/mesin.png" alt="mesin list"/>
                    <p style="margin-left: 20px; display: {displayLabel};">Mesin</p>
                </button>
            </Link>
            <p class="divider"/>
            <Link to="daftarteknisi">
            <button>
                <img src="./icons/teknisi.png" alt="teknisi"/>
                <p style="margin-left: 20px; display: {displayLabel};">Teknisi</p>
            </button>
            </Link>
            <p class="divider"/>
            <Link to="daftarpelanggan">
            <button>
                <img src="./icons/teknisi_tambah.png" alt="pelanggan"/>
                <p style="margin-left: 20px; display: {displayLabel};">Pelanggan</p>
            </button>
             </Link>
            <p class="divider"/>
            <Link to="settings">
            <button>
                ...
                <p style="margin-left: 20px; display: {displayLabel};">Setting</p>
            </button>
        </Link>
        </div>       
    </div>
